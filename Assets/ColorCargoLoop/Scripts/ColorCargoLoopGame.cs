...
namespace ColorCargoLoop
{
    ...
    public sealed class ColorCargoLoopGame : MonoBehaviour
    {
        ...
        {
            // Canvas'i Screen Space - CAMERA yap (KingdomLevel gibi): boylece UI kamera ile render olur
            // ve win panel partikulleri (havai fisek) UI sorting layer'da panelin uzerinde gorunur.
            // (Eski hali Overlay idi -> Overlay'de partikul render edilemiyordu.)
